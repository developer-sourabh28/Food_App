...
const MenuItem = require('./schemas/menuItemsSchema');
const ItemCategory = require('./schemas/categorySchema');
...
const insertData = async () => {
    try {
        if (mongoose.connection.readyState === 1) { // 1 means connected
            console.log("MongoDB is connected, performing insert...");

            // Check existing data and insert new data
            ...
            const updateData = await MenuItem.find({});
...
const insertCatData = async () => {
    try {
        if (mongoose.connection.readyState === 1) { 
            console.log("MongoDB Category data is connected");

            // Check existing data and insert new data
            const fetched_cat_data = await ItemCategory.find({});
        
                 global.foodCategory = categoryData;
                // console.log(global.foodCategory)
              
            console.log("Existing category data:");
            // console.log(fetched_cat_data)

            await ItemCategory.insertMany(categoryData);
            console.log(" Category Data inserted successfully");

            const updateCatData = await ItemCategory.find({});
            console.log("Category Data after Insertion:");
...
module.exports = { insertData, insertCatData }